// src/store/academicsStore.js

import { create } from "zustand";

const useAcademicsStore = create((set) => ({
  departments: [
...
// function Academics() {
//   const departments = useAcademicsStore((state) => state.departments);
//   const teachers = useAcademicsStore((state) => state.teachers);
//   const subjects = useAcademicsStore((state) => state.subjects);
//   const timetable = useAcademicsStore((state) => state.timetable);
