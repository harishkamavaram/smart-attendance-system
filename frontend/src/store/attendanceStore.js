...
const useAttendanceStore = create((set) => ({
  ...
  attendanceHeatmap: Array.from({ length: 7 }).map((_, week) =>
  ...
  generateStudentCalendar: (seedOffset = 0) => {
  ...
  detectedFacesForSession: (sessionId) => {
  ...
  setAttendanceSessions: (attendanceSessions) =>
  ...
  updateAttendanceSession: (id, updatedSession) =>
    set((state) => ({
  ...
  deleteAttendanceSession: (id) =>
    set((state) => ({
      attendanceSessions: state.attendanceSessions.filter(
...
// const weeklyTrend = useAttendanceStore(
//   (state) => state.weeklyAttendanceTrend
// );

// const generateCalendar = useAttendanceStore(
//   (state) => state.generateStudentCalendar
// );

// const detectedFaces = useAttendanceStore(
//   (state) => state.detectedFacesForSession
// );