...
public class SessionDetail {
	...
	public String toString() {
		return "SessionDetail [id=" + id + ", courseName=" + courseName + ", sectionName=" + sectionName
				+ ", sessionName=" + sessionName + ", date=" + date + ", startTime=" + startTime + ", endTime="
				+ endTime + ", room=" + room + ", hasUploadedImage=" + hasUploadedImage + ", totalStudents="
				+ totalStudents + ", present=" + present + ", absent=" + absent + ", accuracy=" + accuracy + ", status="
				+ status + "]";
	}
