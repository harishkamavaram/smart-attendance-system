...
public class Attendance {
	...
	public String toString() {
		return "Attendance [id=" + id + ", sessionId=" + sessionId + ", studentId=" + studentId + ", studentName="
				+ studentName + ", confidence=" + confidence + ", status=" + status + ", markedAt=" + markedAt
				+ ", markedBy=" + markedBy + ", imageName=" + imageName + ", attendanceDate=" + attendanceDate + "]";
	}
